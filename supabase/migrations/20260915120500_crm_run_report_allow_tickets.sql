-- Re-whitelist crm_run_report's allowed datasets to include rpt_tickets.
-- Function body is otherwise unchanged from 20260829161000_crm_run_report_allow_sales_rep_month.sql
