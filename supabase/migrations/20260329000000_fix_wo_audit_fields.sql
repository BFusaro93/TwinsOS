-- ─────────────────────────────────────────────────────────────────────────────
-- Migration: fix_wo_audit_fields
-- Fixes the work_orders tracked fields in fn_audit_log():
--   - Removes assigned_to_ids (IDs are meaningless to users)
--   - Adds categories (multi-category array) for detailed audit entries
--   - Keeps assigned_to_names so multi-assignee changes are audited
-- ─────────────────────────────────────────────────────────────────────────────
