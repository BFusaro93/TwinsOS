-- Replace fn_audit_log with a version that diffs individual fields on generic
-- updates, so the audit trail shows exactly what changed rather than just
-- "Client updated: Brandon Fusaro".
