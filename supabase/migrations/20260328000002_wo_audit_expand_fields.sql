-- ─────────────────────────────────────────────────────────────────────────────
-- Migration: wo_audit_expand_fields
-- Expands the work_orders tracked fields in fn_audit_log() to include
-- assigned_to_names (array), assigned_to_ids, and wo_type so that
-- multi-assignee and category changes produce detailed audit entries
-- instead of the generic "Work Order updated" fallback.
-- ─────────────────────────────────────────────────────────────────────────────
