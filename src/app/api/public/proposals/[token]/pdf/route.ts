...
export async function GET(
  ...
  // The client's copy is the version they were sent, like the page itself.
  const buffer = await renderEstimatePDF(supabase, shareToken.estimate_id, shareToken.org_id, { published: true });
