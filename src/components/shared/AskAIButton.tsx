...
/** Floating action button for the Ask AI support widget. Offset above
 *  FeedbackButton's bottom-5 right-5 (mounted globally in TopBar) since
 *  both are visible together on support pages. */
