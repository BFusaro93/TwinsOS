...
export function JobPhotosGuide() {
  return (
    <DocsFontScope className="flex h-full flex-col gap-6 overflow-y-auto pb-12">
      ...
      <Section id="what-it-is" title="What it is, and where to find it">
        <p>
          ...
          catalog) that gives crews and office staff a
      ...
      <Section id="photo-jobs" title="Photo Jobs">
        <p>
          ...
          for organizing photo documentation by job site. Photo Jobs are distinct
        ...
        <p>
          Both List and Table view modes are available for browsing Photo Jobs, and each job has its
      ...
      <Section id="uploading" title="Uploading photos, videos, and files">
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            to keep uploads workable on poor cell coverage in the field. EXIF is preserved
        ...
        <Callout>
          ...
          composites to <code>job-photos-annotated</code>. Only the storage path is
      ...
      <Section id="annotating" title="Annotating a photo">
        ...
        <p>
          ...
          Once a photo has annotations, both the office
      ...
      <Section id="limitations" title="Known limitations">
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            If no client is explicitly linked, the job is
