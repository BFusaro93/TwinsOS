...
export function OnlinePaymentsGuide() {
  return (
      ...
      <Section id="gotchas" title="Gotchas">
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            ...
            through the same connected account as everything else — card or bank transfer, with your
            card processing fee applying above its usual threshold — but because it happens before
            any invoice exists it&apos;s recorded as an unapplied prepayment rather than against a
