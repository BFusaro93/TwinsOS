...
function AddJobsDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => { onOpenChange(o); if (!o) setInitialized(false); }}>
      <DialogContent className="max-w-2xl p-0 gap-0 max-h-[85vh] flex flex-col rounded-t-none [&>button:last-child]:top-0">
...
function SnowCrewAssignDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="max-w-3xl p-0 gap-0 max-h-[85vh] flex flex-col rounded-t-none [&>button:last-child]:top-0"
