...
import { OverlayLevelContext } from "@/lib/overlay-level"
...
/**
 * Tracks nesting depth of open SheetContent components.
 * Any SheetContent rendered inside another SheetContent (depth > 0)
 * skips the dark overlay so the background stays visible.
 */
...
>(({ side = "right", className, children, ...props }, ref) => {
  ...
  return (
    ...
    // they are already inside an overlay and should not render an additional backdrop.
    <SheetDepthContext.Provider value={depth + 1}>
      <OverlayLevelContext.Provider value={depth + 1}>
        <SheetPortal>
