          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            >
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm font-medium text-brand-600">docs.twinsOS.com</p>
                <p className="mt-1 text-xs text-slate-500">Step-by-step guides and API reference.</p>
              </div>
            </a>
          </div>
        </section>
