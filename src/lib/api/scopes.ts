 ...
 * "clients:read", "requisitions:write:sensitive"). Used by the API key
...
export const API_SCOPE_RESOURCES: ApiScopeResource[] = [
  ...
  { key: "invoices", label: "Invoices", tiers: ["read", "write:sensitive"] },
  { key: "contracts", label: "Contracts", tiers: ["read", "write:sensitive"] },
  ...
  { key: "requisitions", label: "Requisitions", tiers: ["read", "write:safe", "write:sensitive"] },
  { key: "purchase_orders", label: "Purchase Orders", tiers: ["read", "write:sensitive"] },
