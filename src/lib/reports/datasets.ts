...
export const REPORT_DATASETS: ReportDataset[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "unit_of_measure", label: "Chemical Unit", type: "text" },
      { key: "solution_amount", label: "Solution Amount", type: "number", totalable: false },
      { key: "solution_unit_of_measure", label: "Solution Unit", type: "text" },
  ...
  },
  {
    ...
    label: "Audit Log",
    description:
      "Every recorded change across both products — who changed what, when, and from what value to what value.",
    defaultDateField: "occurred_at",
    fields: [
      ...
      { key: "record_label", label: "Record Type", type: "text" },
      { key: "record_kind", label: "Record Type (key)", type: "text" },
      {
        key: "action",
        label: "Action",
        type: "text",
      ...
      { key: "changed_by_email", label: "Email", type: "text" },
      { key: "description", label: "What Changed", type: "text" },
      { key: "field_changed", label: "Field", type: "text" },
      { key: "old_value", label: "From", type: "text" },
      { key: "new_value", label: "To", type: "text" },
    ],
  },
  {
    key: "rpt_tickets",
    label: "Tickets",
    description: "Tickets with status, category, assignee, and due date.",
    defaultDateField: "created_at",
    fields: [
      { key: "ticket_number", label: "Ticket #", type: "number" },
