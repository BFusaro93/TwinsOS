...
export const DASHBOARD_TEMPLATES: DashboardTemplate[] = [
  ...
  },
  {
    ...
    description: "Financials, tickets, jobs, and service insights in one place.",
    seedable: true,
    config: {
      tabs: [
        {
          ...
          panels: [
            ...
            {
              id: "kpi-week-over-week",
              title: "Key Performance Indicators (Month-to-Date)",
              size: "full",
              reportKey: "kpi-week-over-week",
              visual: {
                type: "table",
                useTabDateRange: false,
                valueColumns: [],
            ...
            },
            {
              ...
              title: "Revenue and Budgeted Hours Projection",
              size: "full",
        ...
        },
        {
          ...
          panels: [
            ...
            {
              id: "open-tickets-due-today",
              title: "Open Tickets by Assignee Due Today",
              size: "half",
              visual: {
                type: "bar",
                useTabDateRange: false,
            ...
            {
              id: "my-past-due-tickets",
              title: "My Past Due Tickets",
              size: "half",
              reportKey: "tickets-past-due",
              visual: {
                type: "table",
                useTabDateRange: false,
                valueColumns: [],
        ...
        },
        {
          ...
          panels: [
            {
              id: "profit-loss-accrual",
              title: "Profit / Loss - Accrual Basis",
              size: "half",
              reportKey: "profit-loss-accrual",
              visual: {
                type: "table",
                useTabDateRange: false,
                valueColumns: [],
        ...
        {
          id: "upcoming-jobs-no-contracts",
          name: "Upcoming Jobs - no contracts",
          useDateFilter: false,
          panels: [
            {
              id: "upcoming-jobs-no-contract-report",
              title: "Upcoming Jobs - No Contract",
              size: "full",
              reportKey: "upcoming-jobs-no-contract",
              visual: {
                type: "table",
                useTabDateRange: false,
                valueColumns: [],
        ...
        {
          id: "won-estimates-by-service",
          name: "Won Estimates by Service",
          useDateFilter: false,
          panels: [
            {
              id: "won-estimates-service-summary-report",
              title: "Won Estimates by Service",
              size: "full",
              reportKey: "won-estimates-service-summary",
              visual: {
                type: "table",
                useTabDateRange: false,
                valueColumns: [],
        ...
        {
          id: "products-bulk-material",
          name: "Products/Bulk Material",
          useDateFilter: false,
          panels: [
            {
              id: "invoiced-products-report",
              title: "Invoiced Products Report",
              size: "full",
              reportKey: "invoice-audit-summary",
              visual: {
                type: "table",
                useTabDateRange: false,
                valueColumns: [],
        ...
        },
        {
          ...
          panels: [
            {
              id: "client-contracts-report",
              title: "Contracts",
              size: "full",
              reportKey: "client-contracts",
              visual: {
                type: "table",
                useTabDateRange: false,
                valueColumns: [],
        ...
        {
          id: "services-insights",
          name: "Services Insights",
          useDateFilter: false,
          panels: [
            {
              id: "product-service-usage-report",
              title: "Product and Service Usage",
              size: "full",
              reportKey: "product-service-usage",
              visual: {
                type: "table",
                useTabDateRange: false,
                valueColumns: [],
            ...
            {
              id: "client-count-by-service-report",
              title: "Client Count by Service",
              size: "half",
              reportKey: "client-count-by-service",
              visual: {
                type: "table",
                useTabDateRange: false,
                valueColumns: [],
            ...
            {
              id: "paused-services-report",
              title: "Paused Services",
              size: "half",
              reportKey: "paused-services",
              visual: {
                type: "table",
                useTabDateRange: false,
                valueColumns: [],
