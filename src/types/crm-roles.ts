    ...
    sections: {
      ...
      client_access_cont: {
        ...
        permissions: {
          ...
          client_copy_master_property_cc: "Copy Master Property Credit Card",
      ...
      crm_reports: {
        ...
        permissions: {
          ...
          crm_rpt_client_source_campaigns: "Client Source Campaigns",
      ...
      crm_reports_cont: {
        ...
        permissions: {
          crm_rpt_qb_comparison: "QuickBooks Comparison",
          ...
          crm_rpt_bounced_emails: "Bounced Emails",
          crm_rpt_spam_emails: "Spam Emails",
      ...
      forms: {
        ...
        permissions: {
          ...
          forms_delete_responses: "Delete Responses",
      ...
      email_activity: {
        ...
        permissions: {
          ...
          email_activity_delete: "Delete Emails",
        },
      },
    },
  },
    ...
    sections: {
      ...
      scheduling_reports: {
        ...
        permissions: {
          ...
          sched_rpt_package_sqft_by_round: "Package Sq Ft by Round",
          ...
          sched_rpt_scheduled_to_dos: "Scheduled To Dos",
          sched_rpt_damage: "Damage Report",
          ...
          sched_rpt_sales_by_date_sold_detail: "Sales by Date Sold Detail",
        },
      },
      scheduling_reports_cont: {
        ...
        permissions: {
          ...
          sched_rpt_export_quality_driven: "Export for Quality Driven Software",
          sched_rpt_job_hours_summary: "Job Hours Summary",
          sched_rpt_resource_time_utilization: "Resource Time Utilization",
      ...
      employee_access_cont: {
        ...
        permissions: {
          ...
          emp_reset_password: "Reset Employee Password",
        },
      },
      vendor_access: {
        label: "Vendor Access",
        permissions: {
          ...
          vendor_view_license_info: "View License Info",
      ...
      vendor_access_cont: {
        ...
        permissions: {
          ...
          vendor_edit_password: "Edit Vendor Password",
        },
      },
      chemical_tracking: {
