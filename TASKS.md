...
- [ ] Phase 4 candidate: map tax/discounts as their own QBO invoice lines instead of only line-item totals.
- [ ] Phase 4 candidate: per-service QBO Item mapping instead of the single catchall "Services" item.
